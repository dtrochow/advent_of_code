...
fn draw_diagonal(ocean_floor: &mut OceanFloor, line: Line) {
    let diagonal_length = (line.start.x as i32 - line.end.x as i32).unsigned_abs() as usize;
    /*
        0 1 2 3
    0   o o o o
    1   o S o o
    ...
    */
    if line.start.x < line.end.x && line.start.y < line.end.y {
        for i in 0..=diagonal_length {
            ocean_floor[line.start.y + i][line.start.x + i] += 1;
        }
    }
    /*
        0 1 2 3
    ...
    */
        ...
        for i in 0..=diagonal_length {
            ocean_floor[line.end.y + i][line.end.x + i] += 1;
        }
    }
    /*
        0 1 2 3
...
fn draw_line(ocean_floor: &mut OceanFloor, line: Line) {
    if line.is_vertical() {
        ...
        draw_diagonal(ocean_floor, line);
    }
}
